...
CREATE TABLE vision_configs (
  ...
  left_eye FLOAT DEFAULT 0.0,
  right_eye FLOAT DEFAULT 0.0,
  left_cyl FLOAT DEFAULT 0.0,
  right_cyl FLOAT DEFAULT 0.0,
  left_axis INTEGER DEFAULT 0,
  right_axis INTEGER DEFAULT 0,
  left_ap FLOAT DEFAULT 0.0,
  right_ap FLOAT DEFAULT 0.0,
  left_pd FLOAT DEFAULT 32.0,
  right_pd FLOAT DEFAULT 32.0,
